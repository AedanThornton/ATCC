...
function FocusCardPage() {
  ...
  const cardTypes = {
    "Argonaut": (cardData) => <ArgonautCard key={cardData.cardIDs} argonaut={cardData} />,
    "Gear": (cardData) => <GearCard key={cardData.cardIDs[0]} gear={cardData} />,
    "Pattern": (cardData) => <PatternCard key={cardData.cardIDs[0]} pattern={cardData} />,
    "Titan": (cardData) => <TitanCard key={cardData.cardIDs[0]} titan={cardData} />,
    "Attack": (cardData) => <AttackCard key={cardData.cardIDs[0]} attack={cardData} />,
  };
