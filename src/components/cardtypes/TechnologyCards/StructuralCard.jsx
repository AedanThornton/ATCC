...
const StructuralCard = ({ structural, index }) => {
  return (
    <div className={`technology ${structural.cardSize.replace(" ", "-").toLowerCase()} card`} key={index}>
      <div className="card-info">
        ...
        <div style={{display: "flex", flexDirection: "column"}}>
          ...
          {structural.altname && (<div className="technology-title" style={{ fontSize: Math.min(19, 400 / (1.1 * structural.altname.length)) }}>
            {structural.altname}
          </div>)}
        </div>
